...
## 1. Overview
Welcome to the **Group Presentation** sessions of this PhD course on ICLR papers!

**Objectives:**
- Deeply analyze top ICLR papers (focus: innovations, experiments, impacts).
- Enhance academic presentation, critical thinking, and teamwork skills.
...
| **Q&A + Discussion**   | 5-10 min/group | Audience interaction |
...
| **17-Nov** | CYBERHOST: A ONE-STAGE DIFFUSION FRAMEWORK FOR AUDIO-DRIVEN TALKING BODY GENERATION | 高尚，庞浩天   | 2    | 20–25 min  |
...
- **🚨 Mandatory Prep Step:** 
  ...
  2. **Download & read all reviews** (focus: **scores**, **strengths**, **weaknesses**, **suggestions**).
     ...
     - **Why?** Reviews reveal **real expert critiques** → Elevate your talk from "summary" to "deep analysis".
...
| Role A              | **Method + Related Work** |
|---------------------|---------------------------|
| **Role B**          | **Experiments + Discussion** |
| **Both**            | Q&A support; ≥2 Rehearsals |
